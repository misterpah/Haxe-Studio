...
@:keep @:expose class ManagePlugin
{
	...
	{
	window_index = untyped gui.Window.open("../plugin/plugin.misterpah.ManagePlugin/bin/index.html",{title:"Manage Plugin",focus:true,nodejs:true,min_width:1024,min_height:500,toolbar:true});
